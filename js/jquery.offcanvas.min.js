(function (e) {
    e.fn.offcanvas = function (t) {
        var n = e.extend({hasSidebarLeft: !0, hasSidebarRight: !1, animated: !0, oldPhones: !0, enableTouch: !0, enableKeys: !0}, t), r = e.extend({sidebarLeft: "#sidebarLeft", sidebarRight: "#sidebarRight", mainPage: "#page", leftBurger: "#leftBurger", rightBurger: "#rightBurger"}, t);
        return this.each(function () {
            ...
            var t = 0, i = 0, s = setTimeout(function (t) {
            ...
            n.enableTouch && e(this).hammer({drag: !1, prevent_default: !1, css_hacks: !1}).on("swipe", function (e) {
